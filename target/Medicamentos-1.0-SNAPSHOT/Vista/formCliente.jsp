...
%>
    ...
    <button onclick="toggleDiv()">Mostrar/Ocultar Información</button>
    <div class="container_perfil" id="miDiv">
        <div class="perfil">
            <div class="datos">
                <div>
                    <p>Nombre</p>
        ...
        <div class="actualizaciones">
            <div class="acciones">
                <input class="Boton1" type="button" value="Actualizar Datos" onclick="habilitarInputs()"/>
...
<script>
    ...
    function toggleDiv() {
        ...
        // Alternar la visibilidad del div y mantener su estilo
